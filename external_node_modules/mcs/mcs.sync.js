...
var sync
;(function() {
  var MCSSyncReactNativeModuleGlobal
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var SyncUtils = /** @class */ (function() {
            ...
            for (var pos = 1; pos < keys.length; pos++) {
              if (this.$common.isObject(persistURL.uri.tokens[pos])) {
                ...
                if (persistURL.match[matchId]) {
                  query.attr.push({
                    name:
                      this.$common.stringStartsWith(interName.name, '/') ||
                ...
                if (interName) {
                  query.attr.push({
                    name: interName,
                    value:
                      this.$common.stringStartsWith(interName, '/') || this.$common.stringStartsWith(interName, '_')
                        ? interName.substring(1)
                        : interName,
                    is: false,
          ...
          SyncUtils.prototype.setNestedProperty2 = function(object, property, value, nestedQuery) {
            ...
            if (!this.$common.isArray(property) || !(property.length > 0)) return object
            return property.reduce(function(obj, prop, idx) {
              ...
              if (property.length === idx + 1) {
                if (!prop.isProperty) {
                  if (Array.isArray(obj)) {
                    var index = obj.findIndex(function(item) {
                      return item[prop.name] == _this.nestedUrlPropertyToValue(prop)
                    })
                    if (index > -1) {
              ...
              if (!prop.isProperty) {
                if (Array.isArray(obj)) {
                  var self_1 = _this
                  var index = obj.findIndex(function(item) {
                    return item[prop.name] === self_1.nestedUrlPropertyToValue(prop)
                  })
                  return index > -1 ? obj[index] : {}
                } else {
                  if (obj[prop.name] == _this.nestedUrlPropertyToValue(prop)) {
            ...
            return property.reduce(function(obj, prop) {
              if (prop.isProperty) {
                ...
                if (Array.isArray(obj) && !prop.isProperty) {
                  var index = obj.findIndex(function(item) {
                    return item[keyValue_1.name] == keyValue_1.value
                  })
        ...
        var SyncXMLHttpRequest = /** @class */ (function() {
          ...
          SyncXMLHttpRequest.prototype.open = function(method, url, async, user, password) {
            ...
            if (this.persistentPath === false) {
              this.logger.debug(
                'open',
                'defake and continue with the original object, non of the proxy methods will be used!'
              )
              this.defake()
          ...
          SyncXMLHttpRequest.prototype.send = function(postBody) {
            ...
            var isPolicy = function(policy, value) {
              return _this.persistentPath.isPolicy(policy, value)
            }
            ...
            var $respond = function(status, headers, body) {
              if (isPolicy('fetchPolicy', 'FETCH_FROM_CACHE_SCHEDULE_REFRESH') || _this.isDbFirst) {
                _this.$handler.dispatchEvent(
                  status,
                  SyncXMLHttpRequest.HTTP_STATUS_CODES[status],
                  body,
                  _this.uniqueID()
                )
              } else {
                    ...
                    if (toSync === true) {
                      ...
                      _this.$sync
                        ...
                        .catch(function(error) {
                          return _this.respond2(400, defaultContentHeaders, null)
                        })
                    } else {
            ...
            function reqListener(xhr) {
              ...
              if (xhr.readyState === 4) {
                ...
                if (xhr.status >= 200 && xhr.status < 300) {
                  ...
                  if (
                    isPolicy('noCache', false) &&
                    this.$utils.isSupportedHTTPMethod(parsingModule, this._req.method)
                  ) {
                    ...
                    parsingModule
                      .router(this._req)
                      .then(function() {
                        return $respond(xhr.status, responseHeaders_1, xhrResponse)
                      })
                      .catch(function(err) {
                        _this.logger.error(err)
                    ...
                    if (
                      ...
                      parsingModule
                        ...
                        .then(function(result) {
                          !result
                            ? $respond(xhr.status, responseHeaders_1, xhrResponse)
                            : $respond(xhr.status, responseHeaders_1, result)
                        })
                        .catch(function(error) {
                          $respond(
                            400,
                            responseHeaders_1,
                            'Error while executing operation against the offline database: ' + error
                          )
                        })
                    } else {
                      $respond(xhr.status, responseHeaders_1, xhrResponse)
 ...
 */
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var GenericRequestHandler = /** @class */ (function(_super) {
           ...
           * @deprecated - use buildNestedPropertyArrayParams
           */
          GenericRequestHandler.prototype.createObjFromUrlParametersForEdit = function(
            keyValueObj,
            queryParams,
            payload
          ) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var SyncQueue = /** @class */ (function() {
          ...
          SyncQueue.prototype.next = function() {
            ...
            this.process(this.sync._syncObj)
              .then(function() {
                return _this.doNext(nextObj, _this.sync._syncObj) && setTimeout(_this.next.bind(_this), 1)
              })
              .catch(function(error) {
          ...
          SyncQueue.prototype.runSync = function(force) {
            ...
            if (this.$options.off) return
            if (!force && typeof force !== 'boolean') force = false
            if (this.$options.autoSync === false && force === false) return
          ...
          SyncProcess.prototype.removeAfterReachHighCount = function(obj) {
            ...
            if (this.$options.autoRemoveAfterReachMaxAttemps === true) {
              new Promise(function(resolve) {
                return resolve(_this.sync.removeSyncEntry(obj))
              }).catch(function(err) {
                return _this.onError(err.message, 0)
              })
            }
          }
        ...
        var Sync = /** @class */ (function() {
          ...
          Sync.prototype.commitDBTransaction = function(isError) {
            if (!isError) this._syncLogDirty = true
          ...
          Sync.prototype.buildDBObjectFindQuery = function(requestOptions) {
            ...
            if (!this.$common.isEmpty(url.params) && this.$options.Module.getModuleName() !== 'MCS') {
              ...
              var value =
                url.tokens[0].pattern.indexOf('d') >= 0 ? parseInt(url.params[0].value, 10) : url.params[0].value + ''
              dbQuery[key] = {
                $eq: value,
              }
              ...
              'data' in requestOptions &&
              '$loki' in requestOptions.data &&
              typeof requestOptions.data.$loki === 'number' &&
              !isNaN(requestOptions.data.$loki)
            ) {
              var key = 'data.$loki'
              dbQuery[key] = {
              ...
              '$loki' in requestOptions &&
              typeof requestOptions.$loki === 'number' &&
              !isNaN(requestOptions.$loki)
            ) {
              dbQuery = {
                $loki: {
          ...
          Sync.prototype.syncXhr2 = function(method, url, headers, data, responseType, timeout) {
            ...
            return new Promise(function(resolve, reject) {
              ...
              xhr.send(
                !data || typeof data === 'undefined' || data == null || method === 'DELETE'
                  ? null
                  : JSON.stringify(data)
              )
            })
          ...
          Sync.prototype.getHistory = function(options) {
            var _this = this
            return new Promise(function(resolve) {
              return resolve(_this.getSyncLog(options))
            })
          }
          ...
          Handler.prototype.removeInternListener = function(name) {
            if (name != null) {
              if (this.listeners.hasOwnProperty(name)) {
                this.listeners[name].element.removeEventListener(
                  this.listeners[name].event,
                  this.listeners[name].handler,
                  this.listeners[name].capture
                )
            ...
            for (var name_1 in this.listeners) {
              if (this.listeners.hasOwnProperty(name_1)) {
                if (typeof this.listeners[name_1] === 'object') {
                  this.listeners[name_1].element.removeEventListener(
                    this.listeners[name_1].event,
                    this.listeners[name_1].handler,
                    this.listeners[name_1].capture
                  )
 ...
 */
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Common = /** @class */ (function() {
          ...
          Common.prototype.stringStartsWith = function(string, prefix) {
            if (this.type(string) !== 'string') return false
              ...
              if (this.$common.isNumber(obj)) {
                ...
                if (obj.hasOwnProperty(Process.REQUEST_ID)) {
                  ...
                  if (obj.getResponseHeader(Process.REQUEST_ID) != null) {
                    this.$handler.addListener(
                      obj.getResponseHeader(Process.REQUEST_ID),
                      function(e) {
                        callback(e.detail.data, e.detail.status, e.detail.statusText, e.detail.requestid, e.detail.time)
                      },
                      false
        ...
        var Options = /** @class */ (function() {
          ...
          Options.prototype.setDefaultPolicies = function(config) {
            ...
            if (config.default.conflictResolutionPolicy in this.conflictPolicy) {
              this.defaultPolicy.conflictResolutionPolicy =
                config.default.conflictResolutionPolicy || this.conflictPolicy.PRESERVE_CONFLICT
            }
            ...
            if (config.default.expirationPolicy in this.expirationPolicy) {
              this.defaultPolicy.expirationPolicy =
                config.default.expirationPolicy || this.expirationPolicy.EXPIRE_ON_RESTART
            }
            ...
            if (config.default.fetchPolicy in this.fetchPolicy) {
              this.defaultPolicy.fetchPolicy =
                config.default.fetchPolicy || this.fetchPolicy.FETCH_FROM_SERVICE_IF_ONLINE
            }
          ...
          Options.prototype.setUrlPolicies = function(config) {
            if (
              config.hasOwnProperty('periodicRefreshPolicy') &&
              this.periodicRefreshPolicy.hasOwnProperty(config.periodicRefreshPolicy)
            ) {
              this.clientPolicies.periodicRefreshPolicy =
                config.periodicRefreshPolicy || this.periodicRefreshPolicy.PERIODIC_REFRESH_POLICY_REFRESH_NONE
            }
            if (
              config.hasOwnProperty('periodicRefreshInterval') &&
              typeof config.periodicRefreshInterval === 'number'
            ) {
          ...
          Options.prototype.setPolicyForURL = function(urlPolicyObject) {
            ...
            if (
              'conflictResolutionPolicy' in urlPolicyObject &&
              urlPolicyObject.conflictResolutionPolicy in this.conflictPolicy
            ) {
              urlPolicies.conflictResolutionPolicy =
                urlPolicyObject.conflictResolutionPolicy || this.conflictPolicy.PRESERVE_CONFLICT
            }
          ...
          Options.prototype.setUrlCache = function(options) {
            if (!this.$common.isObject(options)) return
            ...
            if (persistentPath === false) {
              throw new Error(
                'Persistence.Options.setUrlCache()-> URI was not configured for persistence:' + options.url
              )
            }
            ...
            var _loop_1 = function(i) {
              try {
                ...
                cacheItem_1.isPolicy = function(policy, value) {
                  ...
                  if (cacheItem_1.policies && cacheItem_1.policies.hasOwnProperty(policy)) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var MCSSyncModule = /** @class */ (function() {
          function MCSSyncModule(lokiStorageAdapter, logHTTP) {
            if (lokiStorageAdapter === void 0) {
              lokiStorageAdapter = null
            }
            if (logHTTP === void 0) {
              logHTTP = true
            }
            ...
            this._sync = new sync_1.Sync(
              this._events,
              this.common,
              this.options,
              this._utils,
              this._handler,
              this._lokiStorageAdapter
            )
            this.process = new process_1.Process(this.options, this.common, this._handler)
            this.options.module = new mcs_request_handler_1.McsRequestHandler(
              this.options,
              this.common,
              this._utils,
              this._lokiStorageAdapter
          ...
          MCSSyncModule.prototype.setHandler = function(handlerType) {
            ...
            switch (handlerType) {
              case types_1.SyncRequestHandlerTypes.GENERIC:
                handler = new generic_request_handler_1.GenericRequestHandler(
                  this.options,
                  this.common,
                  this._utils,
                  this._lokiStorageAdapter
              ...
              case types_1.SyncRequestHandlerTypes.MCS:
                handler = new mcs_request_handler_1.McsRequestHandler(
                  this.options,
                  this.common,
                  this._utils,
                  this._lokiStorageAdapter
              ...
              case types_1.SyncRequestHandlerTypes.ORACLE_REST:
                handler = new oracle_rest_request_handler_1.OracleRestRequestHandler(
                  this.options,
                  this.common,
                  this._utils,
                  this._lokiStorageAdapter
          ...
          MCSSyncModule.prototype._flush = function(path) {
            return this.options.module.flush(path).then(this._sync.flushCollection.bind(this._sync))
          }
          MCSSyncModule.prototype._install = function() {
            sync_xml_http_request_1.xmlHttpRequestInstall(
              XMLHttpRequest,
              this._sync,
              this._utils,
              this.options,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true })
        var mcs_sync_module_1 = __webpack_require__(58)
        /**
         * MCS module.
         * @global
         * @namespace mcs.sync
         ...
         * @mcs
         */
        var MCSSyncReactNativeModule = /** @class */ (function(_super) {
          __extends(MCSSyncReactNativeModule, _super)
          function MCSSyncReactNativeModule(LokiReactNativeAdapter) {
            return _super.call(this, new LokiReactNativeAdapter()) || this
          }
          return MCSSyncReactNativeModule
        })(mcs_sync_module_1.MCSSyncModule)
        exports.MCSSyncReactNativeModule = MCSSyncReactNativeModule
        MCSSyncReactNativeModuleGlobal = MCSSyncReactNativeModule
  ...
  sync = new MCSSyncReactNativeModuleGlobal(LokiReactNativeAdapter)
})()
